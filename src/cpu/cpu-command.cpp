...
// Queue-family-ownership transfer is a no-op on the CPU backend (single timeline,
// shared memory). Handlers exist only because the command X-macro dispatch
// requires one per command.
